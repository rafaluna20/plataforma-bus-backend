 ...
 */
export class AddPerformanceIndexes1719000001000 implements MigrationInterface {
    name = 'AddPerformanceIndexes1719000001000';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createIndex('trips', new TableIndex({
        ...
        await queryRunner.createIndex('route_waypoints', new TableIndex({
